...
<?php
  ...
  if(!isset($_SESSION["userID"])){
	  ...
	  echo '<div align="right"><p>Olete sisse logitud kui <a href="home.php">'.$userName.'</a>.<br><a href="profile.php">Profiil.</a><br><a href="messages.php">Sõnumid.</a><br><a href="picupload.php">Piltide üleslaadimine.</a><br><a href="?logout=1">Logige välja.</a></p>';
  }
	?></div>
<hr>